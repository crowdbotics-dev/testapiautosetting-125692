...
## Project Structure
    ...
    ├── testapiautosetting_125692  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125692`
...
2. Clone this repo and `cd testapiautosetting_125692`
